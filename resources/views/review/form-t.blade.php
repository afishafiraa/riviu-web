                        ...
                        <div id="kerapihan" class="form-group required"> 
                            ...
                            <div class="controls col-md-8 "> 
                               <div class="rate-kerapihan">
                                        <form action="">
                                            <input class="star star-5" id="star-5" type="radio" name="kerapihan" value="5"/>
                                            <label class="star star-5" for="star-5"></label>
                                            <input class="star star-4" id="star-4" type="radio" name="kerapihan" value="4"/>
                                            <label class="star star-4" for="star-4"></label>
                                            <input class="star star-3" id="star-3" type="radio" name="kerapihan" value="3"/>
                                            <label class="star star-3" for="star-3"></label>
                                            <input class="star star-2" id="star-2" type="radio" name="kerapihan" value="2"/>
                                            <label class="star star-2" for="star-2"></label>
                                            <input class="star star-1" id="star-1" type="radio" name="kerapihan" value="1"/>
